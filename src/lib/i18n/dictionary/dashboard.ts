export const dashboardText = {
  ...
  vehicles_section: { english: 'Vehicles', sinhala: 'වාහන', mixed: 'Vehicles' },
  today_section: { english: 'Today', sinhala: 'අද', mixed: 'Today' },
  this_month_section: { english: 'This Month', sinhala: 'මේ මාසේ', mixed: 'This Month' },
  all_time_section: { english: 'All-Time', sinhala: 'සියලු කාලය', mixed: 'All-Time' },
