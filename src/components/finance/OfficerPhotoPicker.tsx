...
export function OfficerPhotoPicker({ defaultPhotoPath }: { defaultPhotoPath?: string | null }) {
  const { t } = useLanguage();
  ...
  async function handleFile(file: File | undefined) {
    ...
    setIsUploading(true);
    try {
      const path = await compressAndUploadFinancePhoto(file, 'officers');
      setPhotoPath(path);
