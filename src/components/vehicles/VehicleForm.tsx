...
import { createVehicleAction, updateVehicleAction, deleteVehicleImageAction } from '@/app/vehicles/actions';
  ...
  return (
    <form action={handleSubmit} className="space-y-6">
      ...
      <Button type="submit" fullWidth disabled={isPending}>
        {isPending ? t('saving') : isEdit ? t('save_changes') : t('add_vehicle')}
      </Button>
    </form>
  );
}
